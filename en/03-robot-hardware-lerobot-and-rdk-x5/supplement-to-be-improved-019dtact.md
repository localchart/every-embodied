...
Tactile images should not be saved separately. Each frame of the image must include at least the following information:

- Increasingly monotonic timestamp;
...
3. Record a monotonic clock during the capture procedure, using the same time reference as the joint status.
